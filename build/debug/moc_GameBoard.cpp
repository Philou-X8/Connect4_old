...
QT_MOC_LITERAL(3, 19, 8), // "gameTied"
QT_MOC_LITERAL(4, 28, 17), // "toggleColorSignal"
QT_MOC_LITERAL(5, 46, 11), // "hoveredDrop"
QT_MOC_LITERAL(6, 58, 6) // "column"

    },
    "GameBoard\0gameWon\0\0gameTied\0"
    "toggleColorSignal\0hoveredDrop\0column"
};
...
void GameBoard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->gameTied(); break;
        case 2: _t->toggleColorSignal(); break;
        case 3: _t->hoveredDrop((*reinterpret_cast< const int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (GameBoard::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GameBoard::gameTied)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (GameBoard::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GameBoard::toggleColorSignal)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 1
void GameBoard::gameTied()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void GameBoard::toggleColorSignal()
{
