...
#include "../../connect4/NameWidget.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'NameWidget.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_NameWidget_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_NameWidget_t qt_meta_stringdata_NameWidget = {
    {
QT_MOC_LITERAL(0, 0, 10), // "NameWidget"
QT_MOC_LITERAL(1, 11, 10), // "confimName"
QT_MOC_LITERAL(2, 22, 0) // ""

    },
    "NameWidget\0confimName\0"
};
...
void NameWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<NameWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->confimName(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
QT_INIT_METAOBJECT const QMetaObject NameWidget::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_NameWidget.data,
    qt_meta_data_NameWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *NameWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_NameWidget.stringdata0))
